# Desktop v1.3.14 – Windows Docker User Fix
...
- **Symptoms:** Jobs progressed to 20 % and then failed with exit status `125`. Logs showed:
  ```
...
4. Verify backend binary timestamp matches the latest build:
   ...
   ```
5. Launch the app, upload a scan, confirm the job passes 20 % and reaches 100 % with populated metrics and overlays.

---

## 🧪 Testing

- ✅ Windows 11, Docker Desktop 4.32: FastSurfer segmentation completes, outputs generated, metrics saved.
- ✅ macOS Sonoma (Intel), Docker Desktop 4.32: regression-tested, continues to work (no user override applied).
- ✅ Linux Ubuntu 22.04: unaffected.
