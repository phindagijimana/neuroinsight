# Desktop v1.3.13 – Subprocess Scope Fix
...
- ✅ `sub-268_T1w.nii` processed successfully on Windows 11 (CPU-only, Docker Desktop running).
- ✅ Verified FastSurfer Docker pulls and segmentation complete without fallback to mock data.
- ✅ Metrics written to SQLite; overlays available without 404 responses.
